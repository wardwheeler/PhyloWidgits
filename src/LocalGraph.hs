...
to allow for potential swapping FGL graph backend
...
-- | isLeafLablabelled version of isLeaf
isLeafLab ∷ Gr a b → LNode a → Bool
isLeafLab inGraph inNode = G.outdeg inGraph (fst inNode) == 0


-- | isConnectedLeafLablabelled version of isLeaf
isConnectedLeafLablabelled ∷ Gr a b → LNode a → Bool
isConnectedLeafLablabelled inGraph inNode = (G.indeg inGraph (fst inNode) > 0) && (G.outdeg inGraph (fst inNode)) == 0
